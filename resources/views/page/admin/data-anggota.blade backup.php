                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p class="small">Silahkan Mengisi Data Anggota
                                                                    Dibawah !</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-9">
                                                <input id="addName" name="name" type="text" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-9">
                                                <input id="addName" name="tgl_lahir" type="date" class="form-control" placeholder="Tanggal Lahir">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mb-3">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-9">
                                                <input id="addName" name="kelas" type="text" class="form-control" placeholder="kelas">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mb-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-3">
                                <div class="row ">
                                    ...
                                    <div class="col-md-10">
                                        <input name="name" id="addName" type="text" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
                                <div class="row ">
                                    ...
                                    <div class="col-md-10">
                                        <input name="kelas" id="addName" type="text" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
